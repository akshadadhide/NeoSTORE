...
class DrawerNav extends Component{
    ...
    render(){
        ...
        return (
            ...
            <Drawer.Navigator initialRouteName={Home} drawerContent={props => {return <CustomDrawerContent {...props} />}}  drawerType="slide"  drawerStyle={{backgroundColor: StyleConstants.COLOR_000000, width: 300,}} itemStyle= {{color: StyleConstants.COLOR_FFFFFF, }}>
